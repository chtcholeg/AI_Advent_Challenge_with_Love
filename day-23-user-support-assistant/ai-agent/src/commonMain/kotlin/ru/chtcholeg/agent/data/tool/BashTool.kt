...
class BashTool(private val fileSystem: FileSystem) : LocalTool {
    ...
    override val inputSchema = toolSchema {
        string("command", "Bash command to execute (properly quote paths with spaces)", required = true)
        string("description", "Clear description of what this command does (5-10 words for simple commands)")
        integer("timeout", "Optional timeout in milliseconds (max 600000, default 120000)", default = 120000)
    }
