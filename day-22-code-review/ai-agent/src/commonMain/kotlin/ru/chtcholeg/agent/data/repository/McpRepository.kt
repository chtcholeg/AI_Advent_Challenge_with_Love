...
interface McpRepository {
    ...
    /**
     * Get tools filtered by a whitelist of tool names.
     * If allowedNames is null, returns all tools.
     */
    suspend fun getFilteredTools(allowedNames: List<String>?): List<McpTool>
