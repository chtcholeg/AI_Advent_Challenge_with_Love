...
class McpLocalRepositoryImpl(
    ...
    override suspend fun updateErrorMessage(serverId: String, errorMessage: String?) = withContext(Dispatchers.IO) {
        queries.updateErrorMessage(errorMessage, serverId)
    }
