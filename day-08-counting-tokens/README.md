# GigaChat Multiplatform Chat Application (Day 8 - Counting Tokens)
...
- Format: milliseconds (ms) for fast responses, seconds (s) for typical responses, minutes + seconds for long responses
- Examples: "342ms", "2.1s", "1m 15s"

#### Token Usage Display
- Shows total tokens used for each response
- Detailed breakdown: prompt tokens + completion tokens

### Benefits
- **Performance Analysis**: Compare response times across different models and settings
- **Cost Awareness**: Track token usage for API billing purposes
- **Debugging**: Understand why some responses take longer
- **Optimization**: Identify when to adjust max_tokens or simplify prompts
...
├── README.md
├── CLAUDE.md
├── DIFF_07-08.md          # Changelog between Day 7 and Day 8
...
- **DIFF_07-08.md** - Detailed changelog between Day 7 and Day 8
