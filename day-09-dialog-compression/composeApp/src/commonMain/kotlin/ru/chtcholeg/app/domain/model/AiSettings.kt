...
CRITICAL RULES:
1. **LANGUAGE**: Write the summary in the SAME LANGUAGE as the conversation. If the conversation is in Russian, write the summary in Russian. If in English, write in English. Match the primary language of the dialog.
