...
| GIT_MCP_SETUP.md | Git MCP Server quick setup (Day 21) |
...
| ai-agent/GIT_README_DETECTION.md | Git-based README detection strategies (Day 21) |
| COMMANDS_README.md | User guide for `/help` command |
| COMMANDS_GUIDE.md | Technical guide for adding commands |
