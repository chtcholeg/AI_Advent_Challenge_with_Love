...
### 2. Обновлен main.kt
Изменен `composeApp/src/wasmJsMain/kotlin/com/gigachat/app/main.kt` для использования `div` с `id="root"` вместо `document.body`.
...
- `composeApp/src/wasmJsMain/kotlin/com/gigachat/app/main.kt` - Kotlin точка входа
