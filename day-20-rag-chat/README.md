# GigaChat Multiplatform Chat Application (Day 20 - RAG Chat)
...
## Updates in Day 20: RAG Chat

This version is based on all previous features (Days 1-19) and focuses on the RAG Chat capabilities of the application.
...
```bash
cd /Users/shchepilov/AndroidStudioProjects/AI_Advent_Challenge_with_Love/day-20-rag-chat
```
...
**Available Servers**: GitHub (8000), Telegram (8001), Weather (8002), TimeService (8003), Currency (8004), FileOps (8005), Docker (8006)
...
- **ai-agent/COPY_FEATURE.md** - Copy button implementation guide
...
- https://disk.yandex.ru/i/rkCKpGLBfVnx5A
