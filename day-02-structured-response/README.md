...
2. Enable "Structured JSON Response" switch
3. A system message will appear in the chat
4. Ask any question to the AI
5. AI will respond in JSON format
6. Click "Format" button to view beautifully formatted response with:
...
- https://disk.yandex.ru/i/iXc0VuhtEMrMNA