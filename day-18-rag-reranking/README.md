# GigaChat Multiplatform Chat Application (Day 18 - RAG Reranking)
...
```bash
cd /Users/shchepilov/AndroidStudioProjects/AI_Advent_Challenge_with_Love/day-18-rag-reranking
```
...
- https://disk.yandex.ru/i/CD5n0IVyoQKhVg
