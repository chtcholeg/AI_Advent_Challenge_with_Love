...
import ru.chtcholeg.shared.data.mcp.stub.Client
import ru.chtcholeg.shared.data.mcp.stub.ClientCapabilities
import ru.chtcholeg.shared.data.mcp.stub.Implementation
...
import ru.chtcholeg.shared.domain.model.McpFewShotExample
import ru.chtcholeg.shared.domain.model.McpNegativeFewShotExample
        ...
        return try {
            ...
            val tools = toolsListResult.tools.map { tool ->
                McpTool(
                    ...
                    negativeFewShotExamples = tool.negativeFewShotExamples?.map { ex ->
                        McpNegativeFewShotExample(request = ex.request, reason = ex.reason)
                    } ?: emptyList()
                )
            }
