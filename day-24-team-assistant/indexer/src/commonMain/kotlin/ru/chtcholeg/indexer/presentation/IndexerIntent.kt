...
sealed interface IndexerIntent {
    ...
    /**
     * Switch the embedding backend (Ollama / GigaChat)
     */
    data class SelectEmbeddingModel(val model: EmbeddingModelType) : IndexerIntent

    /**
     * Switch input mode (File / URL)
     */
    data class SelectInputMode(val mode: InputMode) : IndexerIntent
}
