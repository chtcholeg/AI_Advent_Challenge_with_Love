...
object AgentConfig {
    ...
    const val MAX_CONTEXT_TOKENS = 80_000
    ...
    const val MAX_MESSAGE_LENGTH = 500_000
    ...
    /** Maximum number of files to include full content in review (prevents context overflow) */
    const val MAX_REVIEW_FILES_WITH_CONTENT = 15
}
