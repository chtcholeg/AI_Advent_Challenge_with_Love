...
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/domain/model/Model.kt` - Model enum with all supported models
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/data/api/HuggingFaceApi.kt` - HuggingFace API interface
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/data/api/HuggingFaceApiImpl.kt` - HuggingFace API implementation
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/data/repository/ChatRepositoryImpl.kt` - Updated to support both GigaChat and HuggingFace
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/di/Koin.kt` - Updated DI configuration
...
#### Files Modified:
- `composeApp/src/commonMain/kotlin/ru/chtcholeg/app/presentation/settings/SettingsScreen.kt`
