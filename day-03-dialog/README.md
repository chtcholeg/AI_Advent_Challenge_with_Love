# GigaChat Multiplatform Chat Application (Day 3 - Dialog Mode)
...
## New in Day 3: Dialog Mode

This version introduces an intelligent dialog mode that enables the AI to gather requirements through interactive conversation. When enabled, the AI asks clarifying questions to collect all necessary information before providing a comprehensive result - perfect for creating technical specifications, project plans, and detailed requirements documents.
...
- **Dialog Mode** (NEW in Day 3) - Interactive requirement gathering through conversation:
...
### Selecting Response Mode (NEW in Day 3)

The application now features three distinct response modes accessible through a dropdown menu in Settings:
...
**Example Dialog Mode Workflow:**
```
User: "I need a technical specification"
AI: "I'll help you create a technical specification. What type of project is this for?"
...
... (continues asking one question at a time until all details are gathered)
```
...
- https://disk.yandex.ru/i/68eHcIUPtHVCUg